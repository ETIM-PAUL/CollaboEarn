...
const TransferModal = ({ isOpen, onClose, userCoinBalance, coinDetails, getUserBalance }) => {
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-4">
                    <label className="text-sm text-gray-500">Recipient Address</label>
                  <input
                    type="text"
                    placeholder="Recipient Address"
                    value={recipientAddress}
                    onChange={(e) => setRecipientAddress(e.target.value)}
                    className="w-full p-2 border text-black font-normal border-gray-300 rounded-lg mb-4"
                  />
                ...
                <div className="mt-4 flex justify-end gap-2">
                  ...
                  <button
                    type="button"
                    disabled={amount <= 0 || transferring || amount > (userCoinBalance ? Number(formatEther(userCoinBalance)) : 0)}
